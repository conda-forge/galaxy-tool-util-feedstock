...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/galaxy-tool-util-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14405&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/galaxy-tool-util-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `galaxy-tool-util` can be installed with:

```
conda install galaxy-tool-util
```

It is possible to list all of the versions of `galaxy-tool-util` available on your platform with:
